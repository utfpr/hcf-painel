...
describe('useLocalStorage', () => {
  test('returns initial value when key exists', () => {
    // arrange
  ...
  test('returns initialValue when key does not exist', () => {
    // arrange
    window.localStorage.clear()
  ...
  test('returns undefined when key does not exist and no initialValue', () => {
    // arrange
    window.localStorage.clear()
  ...
  test('setValue with object stores JSON', () => {
    // arrange
    window.localStorage.clear()
  ...
  test('setValue undefined removes from localStorage', () => {
    // arrange
    window.localStorage.clear()
